...
void main()
{
  ...
  world.addDynamicBody(new RigidBody(    // id = 9
                             9.0f,  // mass
                             Vector3f(0, 0f, -2500f),   // position
                             Quaternionf(0f, 0f, 0f, 1.0f), // orientation
                             new Sphere(Vector3f(0,0,0), 19.0f*1.5f), 0.4f  // geometry
                         )
                        );
    ...
    world.getDynamicBody(9).applyForce(Vector3f(0,0,360000));
    ...
    auto scene = delegate()
    {
        ...
        Sphere10.render (shader.getUniformLocation("meshTransformation"),
                            shader.getUniformLocation("sampler"),
                            world.getDynamicBody(9).transformation * initScaleTransformation(1.5f, 1.5f, 1.5f) //6 sphere
                           );
