...
void main()
{
    ...
    */
    ...
    world.getDynamicBody(0).applyTorque(Vector3f(50000,0,0));

    world.getDynamicBody(1).applyForce(Vector3f(-11000,-1200,0));
    world.getDynamicBody(1).applyTorque(Vector3f(20000,0,0));

    world.getDynamicBody(2).applyForce(Vector3f(16500,1000,0));
    world.getDynamicBody(2).applyTorque(Vector3f(-30000,0,0));
